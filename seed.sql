-- Seed the two existing blog posts into the dr-blog D1 database.
-- Idempotent: re-running replaces rows with the same slug (PK).

INSERT OR REPLACE INTO posts (slug, title, subtitle, author, date, read_time, excerpt, keywords, body_md, header_image, scroll_style, status, original_key, screenshot_key, created_at, updated_at)
VALUES ('conceito-de-doenca-mental', 'Conceito de Doença Mental', 'Epistemologia e Limites da Psiquiatria', 'Gustavo Mendes e Silva, M.D.', '2025-11-05', '30 min', 'O conceito de doença mental representa um dos mais complexos desafios epistemológicos da medicina contemporânea. As fronteiras entre saúde e doença não são meramente biológicas, mas profundamente normativas e contextuais.', '["doença mental","epistemologia","medicalização","psicopatologia","filosofia da psiquiatria"]', '**Autor:** Gustavo Mendes e Silva, M.D.
...
Zachar, P., & Kendler, K. S. (2007). Psychiatric disorders: A conceptual taxonomy. *American Journal of Psychiatry*, 164(4), 557-565.', '/abstract-brain-neural-connections-thinking-philoso.jpg', 'section-overlay', 'published', NULL, NULL, 1762300800000, 1762300800000);

INSERT OR REPLACE INTO posts (slug, title, subtitle, author, date, read_time, excerpt, keywords, body_md, header_image, scroll_style, status, original_key, screenshot_key, created_at, updated_at)
VALUES ('disruptura-cognitiva', 'Disruptura Cognitiva', 'Ruptura e Reorganização da Mente', 'Gustavo Mendes e Silva, M.D.', '2025-11-01', '25 min', 'A mente humana opera através de um arco intencional - a constante reorganização perceptiva, cognitiva e afetiva. Em momentos de crise, esta arquitetura pode sofrer descontinuidades significativas, fenômeno que denominamos disruptura cognitiva.', '["disruptura cognitiva","fenomenologia","psicopatologia","crescimento pós-traumático","reorganização psíquica"]', '**Autor:** Gustavo Mendes e Silva, M.D.
...
Yalom, I. D. (1980). *Existential psychotherapy*. Basic Books.', '/abstract-mind-reorganization-neural-patterns-trans.jpg', 'section-overlay', 'published', NULL, NULL, 1762300800000, 1762300800000);
